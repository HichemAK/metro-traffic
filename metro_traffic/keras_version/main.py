...
model = AttentionRNN(x1s_train.shape[-1], 1, Ty=packet_size, hidden_size_encoder=128, hidden_size_decoder=128,
                     dropout=0.1)
...
model.fit(generator(data_train, target_train, packet_size, step, batch_size=32), epochs=5,
